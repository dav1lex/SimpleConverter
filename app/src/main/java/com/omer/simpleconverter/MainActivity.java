    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgbuton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent int1 = new Intent(getApplicationContext(), lenghtc.class);
                startActivity(int1);
        ...
        imgbuton1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int2 = new Intent(getApplicationContext(), massc.class);
                startActivity(int2);
            }
        });
        ...
        img3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent int3 = new Intent(getApplicationContext(), temperaturec.class);
                startActivity(int3);
            }
        });
